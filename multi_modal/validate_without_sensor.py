...
def print_performance_table(metrics):
    print("Multi-modal Model Performance (without sensor input)")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Validate multi-modal fall detection model without sensor input.")
    parser.add_argument(
        "--feature-dir",
        type=Path,
